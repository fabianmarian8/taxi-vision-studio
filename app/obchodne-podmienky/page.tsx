        ...
        <div className="prose prose-lg max-w-none space-y-8">
          ...
          <section className="space-y-4">
            ...
            <p className="text-foreground/80 leading-relaxed mt-4">
              ...
              <a href="mailto:info@taxinearme.sk" className="underline">info@taxinearme.sk</a>.
            </p>
            <p className="text-foreground/80 leading-relaxed">
          ...
          <section className="space-y-4">
            ...
            <ol className="list-decimal pl-8 space-y-2 text-foreground/80">
              ...
              <li>E-mailom na <a href="mailto:info@taxinearme.sk" className="underline">info@taxinearme.sk</a></li>
            </ol>
            <p className="text-foreground/80 leading-relaxed mt-4">
              Po zrušení:
            </p>
          ...
          <div className="mt-12 p-6 bg-card rounded-lg border-2 border-foreground/10">
            <p className="text-foreground/80 leading-relaxed">
              ...
              <br />
              E-mail: <a href="mailto:info@taxinearme.sk" className="underline">info@taxinearme.sk</a>
            </p>
          </div>
        </div>
