      ...
      <section className="py-12 md:py-16 px-4 md:px-8 bg-white">
        <div className="container mx-auto max-w-4xl">
          <article className="prose prose-lg max-w-none prose-headings:text-gray-900 prose-p:text-gray-800 prose-strong:text-gray-900 prose-li:text-gray-800">
            ...
            <h2 className="text-3xl font-bold mt-12 mb-6">Nástupné sadzby: najvyššie v Bratislave, najnižšie v menších mestách</h2>
            ...
            <h2 className="text-3xl font-bold mt-12 mb-6">Cena za kilometer: vyššia v hlavnom meste, inde často okolo 1 €/km</h2>
            ...
            <h2 className="text-3xl font-bold mt-12 mb-6">Čakacia sadzba: poplatky za státie v premávke</h2>
            ...
            <h2 className="text-3xl font-bold mt-12 mb-6">Odhad ceny typických jázd: mestská trasa vs. letisko</h2>
            ...
            <h2 className="text-3xl font-bold mt-12 mb-6">Záver: Na cene záleží, informovanosť je kľúčová</h2>
            ...
            <h3 className="text-2xl font-bold mt-8 mb-4">Zdroje</h3>
