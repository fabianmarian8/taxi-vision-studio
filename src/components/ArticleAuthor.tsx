...
const author = {
  ...
  bio: 'Peter je redaktor TaxiNearMe.sk so zameraním na taxislužby a dopravnú legislatívu na Slovensku. Venuje sa analýze trhu a prináša overené informácie pre vodičov aj cestujúcich.',
