      ...
      <div className="relative">
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-4 text-sm">
          <div className="flex items-center gap-2">
            ...
            <span className="text-foreground/70">Najlacnejšie (Top 3)</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-4 h-4 rounded-full bg-orange-500"></div>
            <span className="text-foreground/70">Stredné (4-7)</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-4 h-4 rounded-full bg-red-500"></div>
            <span className="text-foreground/70">Najdrahšie (8-10)</span>
          </div>
        </div>
        ...
        {selectedCityData && (
          <div className="mt-6 bg-primary/10 border-2 border-primary rounded-xl p-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
              ...
              <div className="bg-background rounded-lg p-3">
                <p className="text-xs text-foreground/60 mb-1">5km jazda</p>
                <p className="text-xl font-bold text-foreground">
                  {selectedCityData.prices.odhad5km.toFixed(2)} €
                </p>
              </div>
              <div className="bg-background rounded-lg p-3">
                <p className="text-xs text-foreground/60 mb-1">Rebríček</p>
                <p className="text-xl font-bold text-foreground">
