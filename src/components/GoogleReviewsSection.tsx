      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="text-center">
          <a
            ...
            className="inline-flex items-center gap-2 bg-white border-2 border-foreground/20 hover:border-purple-500 text-foreground font-bold px-6 py-3 rounded-lg transition-all hover:shadow-md"
          >
