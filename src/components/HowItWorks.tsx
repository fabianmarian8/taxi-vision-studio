          ...
          {steps.map((step, index) => (
            ...
            >
              <div className="perspective-1000 mb-2 md:mb-4">
                <div className="inline-flex items-center justify-center w-10 h-10 md:w-12 md:h-12 lg:w-14 lg:h-14 rounded-full bg-card shadow-3d-md group-hover:shadow-3d-lg card-3d">
