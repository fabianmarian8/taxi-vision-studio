      ...
      <div className="container mx-auto px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {steps.map((step, index) => (
            ...
            >
              <div className="mb-6 inline-flex items-center justify-center w-24 h-24 rounded-full bg-primary shadow-medium group-hover:shadow-lifted transition-all">
                <step.icon className="h-12 w-12 text-primary-foreground" strokeWidth={1.5} />
              </div>
