        ...
        >
          {isEditMode ? (
            <>
              ...
              <span className="text-sm font-medium">Ukončiť úpravy</span>
            </>
          ) : (
            <>
          ...
          <>
            ...
            >
              ...
              <span className="text-sm">
                {showDiscardConfirm ? 'Potvrdiť?' : 'Zahodiť'}
              </span>
            </button>
            ...
            <button
              ...
              title={saveError ? 'Opravte chybu pred publikovaním' : hasPendingChanges ? 'Počkajte na uloženie' : undefined}
            >
              <Upload className="w-4 h-4" />
              <span className="text-sm font-medium">
                {isPublishing ? 'Publikujem...' : 'Publikovať'}
              </span>
            </button>
          </>
        )}
