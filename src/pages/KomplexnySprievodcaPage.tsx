      ...
      <section className="py-12 md:py-16 px-4 md:px-8 bg-white">
        <div className="container mx-auto max-w-4xl">
          <article className="prose prose-lg max-w-none prose-headings:text-gray-900 prose-p:text-gray-800 prose-strong:text-gray-900 prose-li:text-gray-800">
            ...
            <p>
              <Link to="/prieskum-cien-taxisluzieb-slovensko-2025" className="text-primary hover:underline font-semibold">
            ...
            <div className="bg-red-50 p-8 rounded-lg my-8">
              ...
              <p className="mt-4 font-semibold">
                <Link to="/alkohol-nocny-zivot" className="text-primary hover:underline">
            ...
            <p className="font-semibold text-lg">
              <Link to="/hodnotenie-vodicov" className="text-primary hover:underline">
            ...
            <div className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-xl p-8 my-8">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <Link to="/taxi/bratislava" className="bg-white p-4 rounded-lg shadow hover:shadow-lg transition-shadow">
                ...
                <Link to="/taxi/kosice" className="bg-white p-4 rounded-lg shadow hover:shadow-lg transition-shadow">
                  <h4 className="font-bold text-lg mb-2">Košice</h4>
                  <p className="text-sm text-gray-600">14 taxislužieb</p>
                  <p className="text-sm text-primary mt-2">Zobraziť →</p>
                </Link>

                <Link to="/taxi/presov" className="bg-white p-4 rounded-lg shadow hover:shadow-lg transition-shadow">
                  <h4 className="font-bold text-lg mb-2">Prešov</h4>
                  <p className="text-sm text-gray-600">15 taxislužieb</p>
                  <p className="text-sm text-primary mt-2">Zobraziť →</p>
                </Link>

                <Link to="/taxi/zilina" className="bg-white p-4 rounded-lg shadow hover:shadow-lg transition-shadow">
                  <h4 className="font-bold text-lg mb-2">Žilina</h4>
                  <p className="text-sm text-gray-600">15 taxislužieb</p>
                  <p className="text-sm text-primary mt-2">Zobraziť →</p>
                </Link>

                <Link to="/taxi/nitra" className="bg-white p-4 rounded-lg shadow hover:shadow-lg transition-shadow">
                  <h4 className="font-bold text-lg mb-2">Nitra</h4>
                  <p className="text-sm text-gray-600">13 taxislužieb</p>
                  <p className="text-sm text-primary mt-2">Zobraziť →</p>
                </Link>

                <Link to="/taxi/banska-bystrica" className="bg-white p-4 rounded-lg shadow hover:shadow-lg transition-shadow">
            ...
            <div className="space-y-6 my-8">
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <p>Priemerná 5km jazda stojí 6-9,50 €. Ceny sa líšia podľa mesta a konkrétnej služby. <Link to="/prieskum-cien-taxisluzieb-slovensko-2025" className="text-primary hover:underline">Pozrite si detailný cenový prieskum</Link>.</p>
              </div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <p>Áno, ak ste agresívny, pod vplyvom, neviete cieľ, alebo máte nebezpečné predmety. <Link to="/alkohol-nocny-zivot" className="text-primary hover:underline">Viac info tu</Link>.</p>
              </div>

              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-bold text-lg mb-2">Ako hodnotiť taxislužbu?</h3>
                <p>Férovo - hodnoťte len to, čo vodič ovplyvnil. <Link to="/hodnotenie-vodicov" className="text-primary hover:underline">Prečítajte si návod</Link>.</p>
              </div>
            ...
            <div className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-xl shadow-lg p-8 my-12 text-center">
              ...
              <div className="grid md:grid-cols-3 gap-4 mt-6">
                ...
                <Link to="/hodnotenie-vodicov">
                  <Button variant="outline" className="w-full">
                    Ako hodnotiť vodičov
                  </Button>
                </Link>
                <Link to="/alkohol-nocny-zivot">
                  <Button variant="outline" className="w-full">
                    Bezpečnosť v noci
                  </Button>
                </Link>
...
export default KomplexnySprievodcaPage;
