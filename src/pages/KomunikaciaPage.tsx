        ...
        <div className="container mx-auto max-w-4xl">
          <article className="prose prose-lg max-w-none prose-headings:text-gray-900 prose-p:text-gray-800 prose-strong:text-gray-900 prose-li:text-gray-800">
            ...
            <div className="bg-green-50 p-8 rounded-lg my-8">
              ...
              <p className="mb-4">
                <strong>Zákazník:</strong> Hneď po nastúpení jasne povedz cieľ. Ak máš preferovanú trasu, spomeň to ihneď, nie po 5 minútach jazdy. Podľa britského etikety inštitútu Debrett's by si mal cieľ oznámiť ešte pred nastúpením do vozidla.
              </p>
