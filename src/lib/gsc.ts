...
export function extractCityFromQuery(query: string): string | null {
  // Common Slovak city names
  const cities = [
    'bratislava', 'kosice', 'zilina', 'presov', 'nitra', 'banska-bystrica',
    'trnava', 'trencin', 'martin', 'poprad', 'prievidza', 'zvolen',
    'povazska-bystrica', 'nove-zamky', 'michalovce', 'spisska-nova-ves',
    'komarno', 'humenne', 'levice', 'bardejov', 'liptovsky-mikulas',
    'ruzomberok', 'lucenec', 'piestany', 'topoľcany', 'dubnica', 'cadca',
    'brezno', 'podbrezova', 'rimavska-sobota', 'partizanske', 'vranov',
  ];
